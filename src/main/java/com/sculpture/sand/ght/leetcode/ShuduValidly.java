 ...
 *
 * @author: haitao.gao
 * @create: 2019-11-14 22:38
 */
public class ShuduValidly {
    ...
    public static void main(String[] args) {
        ...
        char[][] test = {{'.','.','.','.','5','.','.','1','.'},{'.','4','.','3','.','.','.','.','.'},{'.','.','.','.','.','3','.','.','1'},{'8','.','.','.','.','.','.','2','.'},{'.','.','2','.','7','.','.','.','.'},{'.','1','5','.','.','.','.','.','.'},{'.','.','.','.','.','2','.','.','.'},{'.','2','.','9','.','.','.','.','.'},{'.','.','4','.','.','.','.','.','.'}};
        char[][] test2 = new char[][]{{'1','2'},{'2','3'}};
        ShuduValidly shuduValidly = new ShuduValidly();
        shuduValidly.isValidSudoku(test);
    }
